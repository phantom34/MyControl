...
import static com.example.administrator.mycontrol.calendar.CalendarUtil.getDayOfWeek;
import static com.example.administrator.mycontrol.calendar.CalendarUtil.getShowDaysoOfMonth;
...
public class CalendarFactory {
    ...
    public static List<CalendarBean> getMonthOfDayList(int y, int m) {
        ...
        //为了塞满42个格子，显示多出当月的天数
        //修改  显示的每一行度有本月的天数
        for (int i = 0; i < getShowDaysoOfMonth(y,m,1) - (fweek - 1) - total; i++) {
