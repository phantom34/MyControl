...
import static com.example.administrator.mycontrol.calendar.CalendarFactory.getMonthOfDayList;
    ...
    private void init() {
        ...
        setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, final int position) {
                ...
                view.setData(getMonthOfDayList(dateArr[0], dateArr[1] + position - Integer.MAX_VALUE / 2), position
                        == Integer.MAX_VALUE / 2);
