...
import com.example.administrator.mycontrol.calendd.views.GridCalendarView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridCalendarView.setDateClick(new MonthView.IDateClick() {
            ...
            public void onClickOnDate(int year, int month, int day) {
                Toast.makeText(GridCalendarActivity.this, "点击了" + year + "-" + month + "-" + day, Toast.LENGTH_SHORT)
                        .show();
            }
        });
    }
